...
$string['course_identity'] = 'Identity of the tutor in this course';
$string['course_identity_help'] = 'Leave a field empty to use what the site configures. The institutional instructions of tone and limits are set for the whole site and cannot be changed here.';
$string['course_tutorname'] = 'Name of the tutor in this course';
$string['course_tutorname_help'] = 'What the tutor is called in the header of the chat of this course. Empty means the name configured for the site. The placeholders of the site work here too.';
$string['course_welcomemessage'] = 'Welcome message in this course';
$string['course_welcomemessage_help'] = 'The first message of the chat in this course. Empty means the message configured for the site. The placeholders of the site work here too.';
...
$string['include_content_desc'] = 'Off by default. When on, the tutor also receives the text written by the teaching side: the description of each activity, the body of a page, the visible chapters of a book, the instructions of an assignment and the address of a URL. It never receives anything written by the people taking the course, such as forum posts, glossary entries, database records, wiki pages or submissions, and never the questions of a quiz or the pages of a lesson. Only the material of activities the user can already open travels. Sending course material to an external service is a decision for whoever is responsible for data protection.';
...
$string['retention_days_desc'] = 'Conversations older than this are deleted, in Moodle and in the AI service. Zero keeps them until the user is deleted, the course is deleted or a privacy request removes them.';
