...
$string['content_chars_per_activity'] = 'Zeichen Material je Aktivität';
$string['content_chars_per_activity_desc'] = 'Wie viel einer einzelnen Aktivität mit einer Frage mitreist. Längerer Text wird gekürzt, und der Tutor wird darauf hingewiesen, dass er einen Auszug liest.';
$string['content_chars_total'] = 'Zeichen Material je Frage';
$string['content_chars_total_desc'] = 'Wie viel Material insgesamt mit jeder Frage reist, über alle Aktivitäten hinweg. Es begrenzt, was jede Antwort an Credits kostet.';
$string['course_identity'] = 'Identität des Tutors in diesem Kurs';
$string['course_identity_help'] = 'Lassen Sie ein Feld leer, um die Einstellung der Website zu verwenden. Die institutionellen Anweisungen zu Ton und Grenzen gelten für die ganze Website und werden hier nicht geändert.';
$string['course_tutorname'] = 'Name des Tutors in diesem Kurs';
$string['course_tutorname_help'] = 'Wie der Tutor in der Kopfzeile des Chats dieses Kurses heißt. Leer bedeutet den Namen der Website. Die Platzhalter der Website funktionieren auch hier.';
$string['course_welcomemessage'] = 'Begrüßung in diesem Kurs';
$string['course_welcomemessage_help'] = 'Die erste Nachricht des Chats in diesem Kurs. Leer bedeutet die Nachricht der Website. Die Platzhalter der Website funktionieren auch hier.';
$string['credits_left'] = 'Verfügbare Credits der Lizenz';
$string['credits_unknown'] = 'Das Credit-Guthaben konnte derzeit nicht abgefragt werden.';
...
$string['enabled_by_default'] = 'Tutor in neuen Kursen aktivieren';
$string['enabled_by_default_desc'] = 'Neue Kurse starten mit eingeschaltetem Tutor, sodass die Einführung nicht Kurs für Kurs erfolgen muss. Lehrende können ihn im eigenen Kurs abschalten.';
...
$string['error_quiz_in_progress'] = 'Der KI-Tutor ist nicht verfügbar, solange ein Testversuch offen ist. Geben Sie ihn ab oder warten Sie, bis die Zeit abläuft, dann kommt der Tutor zurück.';
...
$string['event_service_failed'] = 'Fehler des KI-Dienstes';
$string['event_tutor_used'] = 'KI-Tutor verwendet';
$string['include_content'] = 'Kursmaterial an den KI-Tutor senden';
$string['include_content_desc'] = 'Standardmäßig aus. Eingeschaltet erhält der Tutor auch den von der Lehrseite verfassten Text: die Beschreibung jeder Aktivität, den Text einer Seite, die sichtbaren Kapitel eines Buches, die Anweisungen einer Aufgabe und die Adresse einer URL. Er erhält niemals das, was die Teilnehmenden schreiben, etwa Forenbeiträge, Glossareinträge, Datenbankeinträge, Wiki-Seiten oder Abgaben, und nie die Fragen eines Tests oder die Seiten einer Lektion. Es reist nur Material von Aktivitäten, die die Person bereits öffnen kann. Kursmaterial an einen externen Dienst zu senden, ist eine Entscheidung der Datenschutzverantwortlichen.';
...
$string['max_activities'] = 'Maximale Anzahl an Aktivitäten, die an den Tutor gesendet werden';
$string['max_activities_desc'] = 'Wie viele Aktivitäten des Kurses bei jeder Frage an den KI-Dienst übertragen werden. In einem umfangreichen Kurs verteuert das Senden aller Aktivitäten jede Antwort und verbraucht die Credits schneller. Ausgelassene Aktivitäten werden dem Tutor angekündigt, damit er dies sagen kann, statt ihre Existenz zu verneinen.';
$string['new_conversation'] = 'Neue Unterhaltung';
...
$string['position_overlap_warning'] = 'Diese Position liegt dort, wo Moodle eigene schwebende Bedienelemente anzeigt, etwa die Mitteilungen. Die Schaltfläche kann sie verdecken oder verdeckt werden.';
...
$string['recent_failures'] = 'Fehler des KI-Dienstes';
$string['recent_failures_desc'] = 'Der Tutor hat am letzten Tag {$a} Fehler des KI-Dienstes aufgezeichnet. Suchen Sie das Ereignis Fehler des KI-Dienstes in den Protokollen der Website.';
...
$string['retention_days'] = 'Tage, die Unterhaltungen aufbewahrt werden';
$string['retention_days_desc'] = 'Ältere Unterhaltungen werden in Moodle und im KI-Dienst gelöscht. Null bewahrt sie auf, bis der Nutzer oder der Kurs gelöscht wird oder eine Datenschutzanfrage sie entfernt.';
$string['selected'] = 'ausgewählt';
$string['sendmessage'] = 'Nachricht senden';
$string['service_available'] = 'Der KI-Dienst ist verfügbar.';
$string['service_status'] = 'Dienststatus';
$string['service_unavailable'] = 'Der KI-Dienst ist nicht verfügbar: Der KI-Anbieter ist auf dieser Website deaktiviert.';
$string['student'] = 'Student';
$string['task_purge_old_conversations'] = 'Unterhaltungen nach Ablauf der Aufbewahrungsfrist löschen';
...
$string['usage_in_course'] = '{$a->questions} Fragen in diesem Kurs in den letzten {$a->days} Tagen.';
$string['usage_unknown'] = 'Die Nutzung lässt sich nicht zählen: Diese Website führt kein auswertbares Protokoll.';
