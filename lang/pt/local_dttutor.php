...
$string['content_chars_per_activity'] = 'Caracteres de material por atividade';
$string['content_chars_per_activity_desc'] = 'Quanto viaja de uma mesma atividade com cada pergunta. Um texto maior é cortado e o tutor é avisado de que está lendo um trecho.';
$string['content_chars_total'] = 'Caracteres de material por pergunta';
$string['content_chars_total_desc'] = 'Quanto material viaja no total com cada pergunta, somando todas as atividades. Limita o custo de cada resposta em créditos.';
$string['course_identity'] = 'Identidade do tutor neste curso';
$string['course_identity_help'] = 'Deixe um campo vazio para usar o que o site configura. As instruções institucionais de tom e limites são definidas para todo o site e não se alteram aqui.';
$string['course_tutorname'] = 'Nome do tutor neste curso';
$string['course_tutorname_help'] = 'Como o tutor se chama no cabeçalho do chat deste curso. Vazio significa o nome configurado para o site. Os marcadores do site também funcionam aqui.';
$string['course_welcomemessage'] = 'Mensagem de boas-vindas neste curso';
$string['course_welcomemessage_help'] = 'A primeira mensagem do chat neste curso. Vazio significa a mensagem configurada para o site. Os marcadores do site também funcionam aqui.';
$string['credits_left'] = 'Créditos disponíveis na licença';
$string['credits_unknown'] = 'Não foi possível consultar o saldo de créditos neste momento.';
...
$string['enabled_by_default'] = 'Ativar o tutor em cursos novos';
$string['enabled_by_default_desc'] = 'Cursos novos começam com o tutor ativado, para que a implantação não precise ser feita curso a curso. O professor pode desativá-lo no seu curso.';
...
$string['event_service_failed'] = 'Falha do serviço de IA';
$string['event_tutor_used'] = 'Tutor IA utilizado';
$string['include_content'] = 'Enviar o material do curso ao tutor IA';
$string['include_content_desc'] = 'Desativado por padrão. Quando ativado, o tutor também recebe o texto escrito pela equipe docente: a descrição de cada atividade, o corpo de uma página, os capítulos visíveis de um livro, as instruções de uma tarefa e o endereço de uma URL. Nunca recebe o que escrevem os participantes, como mensagens de fórum, entradas de glossário, registros de base de dados, páginas de wiki ou envios, nem as perguntas de um questionário nem as páginas de uma lição. Só viaja o material das atividades que o usuário já pode abrir. Enviar o material do curso a um serviço externo é uma decisão do responsável pela proteção de dados.';
...
$string['max_activities'] = 'Máximo de atividades enviadas ao tutor';
$string['max_activities_desc'] = 'Quantas atividades do curso são enviadas ao serviço de IA em cada pergunta. Em um curso extenso, enviar todas encarece cada resposta e esgota os créditos mais cedo. As atividades que ficam de fora são anunciadas ao tutor para que ele possa dizê-lo em vez de negar que existam.';
$string['new_conversation'] = 'Nova conversa';
...
$string['position_overlap_warning'] = 'Esta posição fica onde o Moodle coloca seus próprios controles flutuantes, como as mensagens. O botão pode cobri-los ou ficar coberto por eles.';
...
$string['recent_failures'] = 'Falhas do serviço de IA';
$string['recent_failures_desc'] = 'O tutor registrou {$a} falhas do serviço de IA no último dia. Procure o evento Falha do serviço de IA nos registros do site.';
...
$string['retention_days'] = 'Dias que as conversas são mantidas';
$string['retention_days_desc'] = 'Conversas mais antigas são excluídas, no Moodle e no serviço de IA. Zero as mantém até que o usuário seja excluído, o curso seja excluído ou uma solicitação de privacidade as remova.';
$string['selected'] = 'selecionado';
$string['sendmessage'] = 'Enviar mensagem';
$string['service_available'] = 'O serviço de IA está disponível.';
$string['service_status'] = 'Estado do serviço';
$string['service_unavailable'] = 'O serviço de IA não está disponível: o provedor de IA está desativado neste site.';
$string['student'] = 'Estudante';
$string['task_purge_old_conversations'] = 'Excluir conversas que ultrapassam o período de retenção';
...
$string['usage_in_course'] = '{$a->questions} perguntas feitas neste curso nos últimos {$a->days} dias.';
$string['usage_unknown'] = 'O uso do tutor não pode ser contado: este site não mantém um registro consultável.';
