...
$string['content_chars_per_activity'] = 'Caracteres de material por actividad';
$string['content_chars_per_activity_desc'] = 'Cuánto viaja de una misma actividad con cada pregunta. Un texto más largo se recorta y se avisa al tutor de que está leyendo un extracto.';
$string['content_chars_total'] = 'Caracteres de material por pregunta';
$string['content_chars_total_desc'] = 'Cuánto material viaja en total con cada pregunta, sumando todas las actividades. Acota lo que cuesta cada respuesta en créditos.';
$string['course_identity'] = 'Identidad del tutor en este curso';
$string['course_identity_help'] = 'Deje un campo vacío para usar lo que configure el sitio. Las instrucciones institucionales de tono y límites se fijan para todo el sitio y no se cambian aquí.';
$string['course_tutorname'] = 'Nombre del tutor en este curso';
$string['course_tutorname_help'] = 'Cómo se llama el tutor en la cabecera del chat de este curso. Vacío significa el nombre configurado para el sitio. Los marcadores del sitio también funcionan aquí.';
$string['course_welcomemessage'] = 'Mensaje de bienvenida en este curso';
$string['course_welcomemessage_help'] = 'El primer mensaje del chat en este curso. Vacío significa el mensaje configurado para el sitio. Los marcadores del sitio también funcionan aquí.';
$string['credits_left'] = 'Créditos disponibles en la licencia';
$string['credits_unknown'] = 'No se pudo consultar el saldo de créditos en este momento.';
...
$string['enabled_by_default'] = 'Activar el tutor en los cursos nuevos';
$string['enabled_by_default_desc'] = 'Los cursos nuevos empiezan con el tutor activado, de modo que la puesta en marcha en todo el sitio no obliga a entrar curso por curso. El docente puede desactivarlo en su curso.';
...
$string['error_provider_disabled'] = 'El Tutor IA no está disponible porque el proveedor de IA está desactivado en este sitio. Por favor, contacte a su administrador.';
$string['error_quiz_in_progress'] = 'El Tutor IA no está disponible mientras tienes un intento de cuestionario abierto. Envíalo, o espera a que se agote su plazo, y el tutor vuelve.';
$string['error_ratelimit_exceeded'] = 'Se ha superado el límite de consumo permitido. Por favor, inténtelo de nuevo el {$a}.';
...
$string['event_service_failed'] = 'Fallo del servicio de IA';
$string['event_tutor_used'] = 'Tutor IA utilizado';
$string['include_content'] = 'Enviar el material del curso al tutor IA';
$string['include_content_desc'] = 'Desactivado por defecto. Al activarlo, el tutor recibe también el texto redactado por el profesorado: la descripción de cada actividad, el cuerpo de una página, los capítulos visibles de un libro, las instrucciones de una tarea y la dirección de una URL. Nunca recibe lo que escriben quienes cursan, como mensajes de foro, entradas de glosario, registros de base de datos, páginas de wiki o entregas, ni las preguntas de un cuestionario ni las páginas de una lección. Solo viaja el material de las actividades que el usuario ya puede abrir. Enviar el material del curso a un servicio externo es una decisión del responsable de protección de datos.';
...
$string['max_activities'] = 'Máximo de actividades enviadas al tutor';
$string['max_activities_desc'] = 'Cuántas actividades del curso viajan al servicio de IA con cada pregunta. En un curso extenso, enviarlas todas encarece cada respuesta y agota antes los créditos. Las actividades que quedan fuera se anuncian al tutor para que pueda decirlo en lugar de negar que existan.';
$string['new_conversation'] = 'Nueva conversación';
...
$string['position_overlap_warning'] = 'Esta posición coincide con la zona donde Moodle coloca sus propios controles flotantes, como el cajón de mensajería. El botón puede taparlos o quedar tapado por ellos.';
...
$string['recent_failures'] = 'Fallos del servicio de IA';
$string['recent_failures_desc'] = 'El tutor registró {$a} fallos del servicio de IA en el último día. Busque el evento Fallo del servicio de IA en los registros del sitio para ver cuáles fueron.';
...
$string['retention_days'] = 'Días que se conservan las conversaciones';
$string['retention_days_desc'] = 'Las conversaciones más antiguas se eliminan, en Moodle y en el servicio de IA. Cero las conserva hasta que se elimine el usuario, se elimine el curso o lo pida una solicitud de privacidad.';
$string['selected'] = 'seleccionado';
$string['sendmessage'] = 'Enviar mensaje';
$string['service_available'] = 'El servicio de IA está disponible.';
$string['service_status'] = 'Estado del servicio';
$string['service_unavailable'] = 'El servicio de IA no está disponible: el proveedor de IA está desactivado en este sitio.';
$string['student'] = 'Estudiante';
$string['task_purge_old_conversations'] = 'Eliminar las conversaciones que superan el periodo de retención';
...
$string['usage_in_course'] = '{$a->questions} preguntas realizadas en este curso en los últimos {$a->days} días.';
$string['usage_unknown'] = 'No se puede contar el uso del tutor: este sitio no conserva un registro consultable.';
