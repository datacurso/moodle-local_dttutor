...
$string['content_chars_per_activity'] = 'Caractères de matériel par activité';
$string['content_chars_per_activity_desc'] = 'Quelle part d\'une même activité circule avec une question. Un texte plus long est coupé et le tuteur est averti qu\'il lit un extrait.';
$string['content_chars_total'] = 'Caractères de matériel par question';
$string['content_chars_total_desc'] = 'Quelle quantité de matériel circule au total avec chaque question, toutes activités confondues. Cela borne le coût de chaque réponse en crédits.';
$string['course_identity'] = 'Identité du tuteur dans ce cours';
$string['course_identity_help'] = 'Laissez un champ vide pour utiliser ce que configure le site. Les consignes institutionnelles de ton et de limites sont fixées pour tout le site et ne se changent pas ici.';
$string['course_tutorname'] = 'Nom du tuteur dans ce cours';
$string['course_tutorname_help'] = 'Le nom du tuteur dans l\'en-tête du chat de ce cours. Vide signifie le nom configuré pour le site. Les marqueurs du site fonctionnent aussi ici.';
$string['course_welcomemessage'] = 'Message d\'accueil dans ce cours';
$string['course_welcomemessage_help'] = 'Le premier message du chat dans ce cours. Vide signifie le message configuré pour le site. Les marqueurs du site fonctionnent aussi ici.';
$string['credits_left'] = 'Crédits restants sur la licence';
$string['credits_unknown'] = 'Le solde de crédits n\'a pas pu être consulté pour le moment.';
...
$string['enabled_by_default'] = 'Activer le tuteur dans les nouveaux cours';
$string['enabled_by_default_desc'] = 'Les nouveaux cours démarrent avec le tuteur activé, afin que le déploiement ne se fasse pas cours par cours. L\'enseignant peut le désactiver dans son cours.';
...
$string['error_provider_disabled'] = 'Le Tuteur IA n\'est pas disponible car le fournisseur d\'IA est désactivé sur ce site. Veuillez contacter votre administrateur.';
$string['error_quiz_in_progress'] = 'Le Tuteur IA n\'est pas disponible tant qu\'une tentative de test est ouverte. Envoyez-la, ou attendez la fin du délai, et le tuteur revient.';
$string['error_ratelimit_exceeded'] = 'La limite de consommation autorisée a été dépassée. Veuillez réessayer le {$a}.';
$string['error_tutor_disabled_site'] = 'Le Tuteur IA est désactivé sur ce site. Contactez l\'administrateur du site si vous avez besoin de l\'activer.';
...
$string['event_service_failed'] = 'Échec du service d\'IA';
$string['event_tutor_used'] = 'Tuteur IA utilisé';
$string['include_content'] = 'Envoyer le matériel du cours au tuteur IA';
$string['include_content_desc'] = 'Désactivé par défaut. Activé, le tuteur reçoit aussi le texte rédigé par l\'équipe enseignante : la description de chaque activité, le corps d\'une page, les chapitres visibles d\'un livre, les consignes d\'un devoir et l\'adresse d\'une URL. Il ne reçoit jamais ce qu\'écrivent les personnes inscrites, comme les messages de forum, les entrées de glossaire, les enregistrements de base de données, les pages de wiki ou les remises, ni les questions d\'un test ni les pages d\'une leçon. Seul le matériel des activités que la personne peut déjà ouvrir circule. Envoyer le matériel d\'un cours à un service externe relève du responsable de la protection des données.';
...
$string['max_activities'] = 'Nombre maximal d\'activités envoyées au tuteur';
$string['max_activities_desc'] = 'Combien d\'activités du cours sont transmises au service d\'IA à chaque question. Dans un cours volumineux, les envoyer toutes renchérit chaque réponse et épuise les crédits plus vite. Les activités laissées de côté sont annoncées au tuteur afin qu\'il puisse le dire au lieu de nier leur existence.';
$string['new_conversation'] = 'Nouvelle conversation';
...
$string['position_overlap_warning'] = 'Cette position se trouve là où Moodle place ses propres contrôles flottants, comme la messagerie. Le bouton peut les masquer ou être masqué par eux.';
...
$string['recent_failures'] = 'Échecs du service d\'IA';
$string['recent_failures_desc'] = 'Le tuteur a enregistré {$a} échecs du service d\'IA au cours du dernier jour. Cherchez l\'événement Échec du service d\'IA dans les journaux du site.';
...
$string['retention_days'] = 'Jours de conservation des conversations';
$string['retention_days_desc'] = 'Les conversations plus anciennes sont supprimées, dans Moodle et dans le service d\'IA. Zéro les conserve jusqu\'à la suppression de l\'utilisateur, du cours ou à une demande de confidentialité.';
$string['selected'] = 'sélectionné';
$string['sendmessage'] = 'Envoyer le message';
$string['service_available'] = 'Le service d\'IA est disponible.';
$string['service_status'] = 'État du service';
$string['service_unavailable'] = 'Le service d\'IA n\'est pas disponible : le fournisseur d\'IA est désactivé sur ce site.';
$string['student'] = 'Étudiant';
$string['task_purge_old_conversations'] = 'Supprimer les conversations au-delà de la durée de conservation';
...
$string['usage_in_course'] = '{$a->questions} questions posées dans ce cours au cours des {$a->days} derniers jours.';
$string['usage_unknown'] = 'L\'usage du tuteur ne peut pas être compté : ce site ne conserve aucun journal consultable.';
